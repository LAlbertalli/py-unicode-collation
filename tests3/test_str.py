...
class TestUnicodeDict(unittest.TestCase):
    def setUp(self):
        self.ger = 'Straße'
        self.acc = 'àèìòùáéíóúaeiouãẽĩõũâêîôû'
        self.noacc = 'aeiouaeiouaeiouaeiouaeiou'
        self.csacc = 'AEIOUaeiouaeiouaeiouaeiou'
    ...
    def test_comparison(self):
        ...
        self.assertFalse(self.unicode_ci(self.ger) != self.unicode_ci('Straße'))
        ...
        self.assertFalse(self.unicode_ci('ñ') != self.unicode_ci('n'))
        self.assertFalse(self.unicode_st('ñ') == self.unicode_st('n'))
        self.assertFalse(spanish_ci('ñ') == spanish_ci('n'))
