...
class unicode_str_base(str):
    ...
    def __mod__(self,x):
        '''x.__mod__(y) <==> x%y
        '''
        return self.__class__(str.__mod__(self,x))

    def __mul__(self,x):
        '''x.__mul__(y) <==> x%y
        '''
        return self.__class__(str.__mul__(self,x))
    ...
    def __repr__(self):
        ...
        return 'unicode_str(%s, locale=%s, comparison_level=%d)' % \
            (str.__repr__(self)[1:],self._factory.locale, self._factory.comparison_level)
    ...
    def center(self, width, fillchar=' '): 
        ...
        '''
        return self.__class__(str.center(self, width, fillchar))
    ...
    def decode(self,encoding=__marker,errors='strict'):
        ...
        '''
        if encoding == self.__marker:
            return self.__class__(str.decode(self))
        else:
            return self.__class__(str.decode(self, encoding, errors))
    ...
    def encode(self,encoding=__marker,errors='strict'):
        ...
        '''
        if encoding == self.__marker:
            return self.__class__(str.encode(self))
        else:
            return self.__class__(str.encode(self, encoding, errors))

    def endswith(suffix, start = 0, end = sys.maxsize):
    ...
    def join(self, iterable):
        ...
        '''
        return self.__class__(str.join(self, iterable))
    ...
    def ljust(self, witdh, fillchar=' '):
        ...
        '''
        return self.__class__(str.ljust(self, witdh, fillchar=' '))
    ...
    def replace(old, new, count = sys.maxsize):
    ...
    def rjust(self, witdh, fillchar=' '):
        ...
        '''
        return self.__class__(str.rjust(self, witdh, fillchar=' '))
    ...
    def rsplit(self, sep = None, maxsplit = sys.maxsize):
    ...
    def startswith(prefix, start = 0, end = sys.maxsize):
    ...
    def __reduce__(self):
        ...
        for k in vars(self.__class__('')):
            inst_dict.pop(k, None)
        return (self._factory, (str(self),), inst_dict)
